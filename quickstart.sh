...
start_stack() {
  ...
  cat > .env << INNER_EOF
# EdgeQuake Configuration - Generated by quickstart.sh
# This file contains your selected settings for persistent use with Docker Compose
# You can edit this file and restart services with: docker compose -f docker-compose.quickstart.yml down && docker compose -f docker-compose.quickstart.yml up -d
...
# =============================================================================
# Vision Provider Configuration (for PDF processing)
# =============================================================================
...
# =============================================================================
EDGEQUAKE_IMAGE_REGISTRY=${EDGEQUAKE_IMAGE_REGISTRY:-ghcr.io}
EDGEQUAKE_IMAGE_NAMESPACE=${EDGEQUAKE_IMAGE_NAMESPACE:-noxomix}
...
INNER_EOF
  ...
  [ -n "$MISTRAL_API_KEY" ] && echo "MISTRAL_API_KEY=$MISTRAL_API_KEY" >> .env
  [ -n "$XAI_API_KEY" ] && echo "XAI_API_KEY=$XAI_API_KEY" >> .env
  [ -n "$AZURE_OPENAI_API_KEY" ] && echo "AZURE_OPENAI_API_KEY=$AZURE_OPENAI_API_KEY" >> .env
  [ -n "$AZURE_OPENAI_ENDPOINT" ] && echo "AZURE_OPENAI_ENDPOINT=$AZURE_OPENAI_ENDPOINT" >> .env
  [ -n "$GOOGLE_CLOUD_PROJECT" ] && echo "GOOGLE_CLOUD_PROJECT=$GOOGLE_CLOUD_PROJECT" >> .env
  [ -n "$GOOGLE_ACCESS_TOKEN" ] && echo "GOOGLE_ACCESS_TOKEN=$GOOGLE_ACCESS_TOKEN" >> .env
  [ -n "$SCW_SECRET_KEY" ] && echo "SCW_SECRET_KEY=$SCW_SECRET_KEY" >> .env
  [ -n "$EDGEQUAKE_CHAT_API_KEY" ] && echo "EDGEQUAKE_CHAT_API_KEY=$EDGEQUAKE_CHAT_API_KEY" >> .env
  [ -n "$EDGEQUAKE_EMBEDDING_API_KEY" ] && echo "EDGEQUAKE_EMBEDDING_API_KEY=$EDGEQUAKE_EMBEDDING_API_KEY" >> .env
  ui_ok ".env file created successfully with your configuration!"
